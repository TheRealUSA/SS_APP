...
<div className="bg-cover bg-center min-h-screen z-1 relative" style={{
  backgroundImage: 'url("/Img/inicioFotoFondo.png")',
}}>
        ...
        <div className="flex flex-col justify-center items-center mt-20 text-white text-center">
          ...
          <button className="bg-[#D1C6AE] hover:bg-zinc-100 text-black font-bold py-2 px-4 mt-6 mb-5 rounded-full">
            Explorar Ahora
          </button>
        </div>
      </div>
      <div className="bg-[#D1C6AE] text-center">
        <h1 className="text-4xl font-semibold text-black mt-10">
